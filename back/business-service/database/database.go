...
func init() {
	username := config.GetConfigSevere("db", "username")
	password := config.GetConfigSevere("db", "password")
	host := config.GetConfigSevere("db", "host")
	port := config.GetConfigSevere("db", "port")
	database := config.GetConfigSevere("db", "database")
	maxIdleConns := config.GetIntConfigSevere("db", "maxIdleConns")
	maxOpenConns := config.GetIntConfigSevere("db", "maxOpenConns")
	connMaxLifetime := config.GetIntConfigSevere("db", "connMaxLifetime")
